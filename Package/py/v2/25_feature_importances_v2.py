...
model_math = load(f'{MODEL_DIR}/v2/best_model_v2.joblib')
...
print("Feature Importance 前10名:")
print(importance_df.head(10).to_string(index=False, formatters={'Importance': '{:.3f}'.format}))
print('-'*100)
importance_df.to_html(f'{DATA_DIR}/v2/feature_importance_v2.html')
...
plt.tight_layout()
plt.legend()
plt.savefig(f'{DATA_DIR}/v2/feature_importance_results_v2.png')
plt.show()