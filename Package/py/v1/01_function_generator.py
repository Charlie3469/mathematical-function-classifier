...
dataset_df.to_csv(f'{PROJECT_DIR}/data/v1/function_dataset.csv', index=False)       # 儲存檔案
print("已建立數據資料\n")

metadata_df = pd.DataFrame(metadata_rows)
metadata_df.to_csv(f'{PROJECT_DIR}/data/v1/function_metadata.csv', index=False)     # 儲存檔案
print("已建立metadata資料")
