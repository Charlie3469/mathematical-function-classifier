...
# 儲存檔案
dataset_df.to_csv(r'D:\Python\我的AI作品集\專案1_數學函數辨識\data\function_dataset.csv', index=False)
metadata_df.to_csv(r'D:\Python\我的AI作品集\專案1_數學函數辨識\data\function_metadata.csv', index=False)
print("數據資料建立完成！")