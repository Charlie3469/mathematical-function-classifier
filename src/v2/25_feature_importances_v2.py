...
model_math = load('models/v2/best_model_v2.joblib')
...
print('-'*100)
importance_df.to_html('data/v2/feature_importance_v2.html')
...
plt.tight_layout()
plt.legend()
plt.savefig('data/v2/feature_importance_top10_v2.png')
plt.show()