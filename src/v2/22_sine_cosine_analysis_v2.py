...
# 透過樣本編號對應到 metadata
error_metadata = test_df.merge(metadata, on='sample_id', how='left', validate='one_to_one')
...
# 儲存參數統計比較
para_sum_df.to_html('data/v2/sine_cosine_parameter_analysis_v2.html')
...
plt.tight_layout()
plt.legend()
plt.savefig('data/v2/sine_cosine_error_analysis_v2.png')
plt.show()