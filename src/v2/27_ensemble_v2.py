...
# 讀取資料
data = pd.read_csv('data/v2/function_dataset_merged_v2.csv')
...
baseline_model = joblib.load('models/v2/best_model_v2.joblib')
...
tuned = joblib.load('models/v2/best_model_tuned_v2.joblib')
...
joblib.dump(model_package, 'models/v2/final_model_v2.joblib')
print("已儲存 V2 最終模型!")