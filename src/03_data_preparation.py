...
df1.to_csv(r'D:\Python\我的AI作品集\專案1_數學函數辨識\data\function_dataset_cleaned.csv', index=False)
...
df2 = df_metadata
df2.to_csv(r'D:\Python\我的AI作品集\專案1_數學函數辨識\data\function_metadata.csv', index=False)
